...
\section{Comparison}
In order to provide a complete overview of the heuristics, sets of 100, 500, and 1000 items were used on strips of lengths 1500, 2500, and 5000. Item widths were randomly selected between 150 and 1000, and score widths between 1 and 70. This ensures that each item has two score lines. 
