...
\draw [dashed,myRed] (7,2) -- (10,2);
\draw [dashed,myRed] (7,5) -- (10,5);
...
\node [above] at (7,5.1) {\huge{$v_3$}};
\node [below] at (7.1,1.9) {\huge{$v_{12}$}};

\node [below] at (15,-0.1) {\huge{$v_8$}};
\node [below] at (12,-0.1) {\huge{$v_7$}};
\node [below] at (10,1.9) {\huge{$v_4$}};
\node [above] at (9.9,5.1) {\huge{$v_{11}$}};
