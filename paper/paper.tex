...
The one-dimensional bin packing problem (BPP) is a widely researched problem \\
The problem is as follows: given a set of $n$ weighted items  and a finite number of bins with equal capacity $c$, find the minimum number of bins required to contain all of the items. NP-Hard \cite{garey1979}, \cite{coffman1984}, \cite{lewis2017}, \cite{becker2015}, \cite{becker2010}, \cite{goulimis2004}, \cite{karp1972}, \cite{mahadev1995}.
