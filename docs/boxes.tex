...
\node [above] at (4.35,2) {\scriptsize $8$};
\node [above] at (7.05,2) {\scriptsize $15$};
\node at (5.7, 1) {8};
...
\node [above] at (8.55,2) {\scriptsize $13$};
\node [above] at (12.35,2) {\scriptsize $14$};
\node at (10.45, 1) {9};
%%%
...
\node [above] at (1.8,5) {\scriptsize $4$};
\node [above] at (6.1,5) {\scriptsize $17$};
\node at (3.95, 4) {5};
...
\node [above] at (7.6,5) {\scriptsize $5$};
\node [above] at (10.8,5) {\scriptsize $9$};
\node at (9.2, 4) {6};
%%%
...
\node [above] at (1.275,8) {\scriptsize $0$};
\node [above] at (2.375,8) {\scriptsize $6$};
\node at (1.825, 7) {1};
...
\node [above] at (4.375,8) {\scriptsize $1$};
\node [above] at (5.725,8) {\scriptsize $10$};
\node at (5.05, 7) {2};
...
\node [above] at (7.725,8) {\scriptsize $2$};
\node [above] at (8.725,8) {\scriptsize $16$};
\node at (8.226, 7) {3};
...
\node [above] at (10.725,8) {\scriptsize $3$};
\node [above] at (11.325,8) {\scriptsize $11$};
\node at (11.025, 7) {4};
